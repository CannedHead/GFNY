<?php include 'header.php';?>         
          ...
          <div class="patrocinadores col-xs-12">
            <div class="col-xs-6 col-sm-1 col-sm-offset-4">
              <img class="img-responsive" src="https://s3-sa-east-1.amazonaws.com/cannedhead.gfny/Logotipo+Strava-01.png">
            </div>
            <div class="col-xs-6 col-sm-2">
              <img class="img-responsive" src="https://s3-sa-east-1.amazonaws.com/cannedhead.gfny/LOGO-CRM+CMYK_SLOGAN.png">
            </div>
          </div>
          <!-- END PATROCINADORES -->
